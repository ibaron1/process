DECLARE @SchemaName VARCHAR(40) = null 
--'dbo';
...
SELECT 
    ...
    [partition_sums].[reserved_in_row_KB],
    [partition_sums].[reserved_LOB_KB],
...
FROM 
    ...
    OUTER APPLY (
        SELECT COUNT(*) AS partition_count,
               CAST(SUM([ps].[in_row_reserved_page_count]) * 8. / 1024 AS NUMERIC(32, 1)) AS reserved_in_row_KB,
               CAST(SUM([ps].[lob_reserved_page_count]) * 8. AS NUMERIC(32, 1)) AS reserved_LOB_KB,
