...
SELECT
    ...
    bt.host_name,
	/*Tools like Tableau, Power BI, or custom Java apps use JDBC or ODBC to connect. 
	If the application doesn't explicitly set the ApplicationName in the connection string, 
	SQL Server will just show the driver name (e.g., "Microsoft JDBC Driver for SQL Server")*/
    bt.program_name, 
    bt.status,
    bt.command,
    bt.database_name,
